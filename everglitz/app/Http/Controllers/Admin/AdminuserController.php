...
class AdminuserController extends Controller
{
    function index(Request $request)
    {
		...
		if($method=='POST')
		{
			...
			$val_array    = array( "username"=>array($username,'name required'),
	...
	function Add(Request $request)
    {
		...
		if($method=='POST')
		{
            ...
            $val_array        = array( "user_name"=>array($data['user_name'],'user name required'),
                                        "user_type"=>array($data['user_type'],
            ...
            if(empty($data['error_msg']))
            {
                $insert_array  = array("user_name"=>$data['user_name'],
	...
	function Update(Request $request)
    {
		...
		if($method=='POST')
		{
            ...
            if(empty($data['error_msg']))
            {
				if($data['password'] !="")
				{
					$update_array  = array("user_name"=>$data['user_name'],
											"user_type"=>$data['user_type'],
											"password"=>$pass);
				}
				else
